...
export { default as SoundManager }      from './controllers/SoundManager'
export { default as StateManager }      from './controllers/StateManager'
...
export { default as HeroicLabs }        from './services/HeroicLabs'
export { default as App42Shepartz }     from './services/App42Shepartz'
export { default as Locker }            from './services/Locker'
export { default as Hello }             from './services/Hello'
